...
public class StudentResultSheet2 {
    public static class StudentResultSheet {
        public static void main(String[] args) {
            ...
            System.out.println( "Avarage of Total marks  :" + avaragepersentage );

            if ((avaragepersentage < 35) || (math < 35) || (english < 35) || (physics > 35)){
